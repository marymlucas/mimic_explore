...
(
    ...
    LEFT JOIN mimic_derived.ventilation v
        ...
        AND (
            v.starttime BETWEEN ie.intime AND (ie.intime + INTERVAL '1 DAY')
        OR v.endtime BETWEEN ie.intime AND (ie.intime + INTERVAL '1 DAY')
...
select ie.subject_id, ie.hadm_id, ie.stay_id
      ...
      , ie.outtime
      , adm.deathtime
      , extract (epoch from ie.intime - adm.admittime)/60 as preiculos
      , ag.age
      , gcs.gcs_min
